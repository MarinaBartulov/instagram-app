...
insert into post (description, photo_path, user_id, date_time, deleted) values ('This is my post.', 'assets\\images\\image1.jpg', 1, '2020-09-19 04:00:00', false);
insert into post (description, photo_path, user_id, date_time, deleted) values ('Photo from Paris.', 'assets\\images\\image2.jpg', 1, '2020-09-20 04:00:00', false);
insert into post (description, photo_path, user_id, date_time, deleted) values ('Photo from Paris!!!', 'assets\\images\\image3.jpg', 2, '2020-09-21 04:00:00', false);
insert into post (description, photo_path, user_id, date_time, deleted) values ('New photo!', 'assets\\images\\image4.jpg', 3, '2020-09-22 04:00:00', false);
